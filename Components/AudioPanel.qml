...
Item {
    ...
    onOpenChanged: {
        if (open) {
            Settings.audioPanelHeight = panelRect.implicitHeight + panelMarginTop;
        } else {
            Settings.audioPanelHeight = 0;
        }
    }
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            onImplicitHeightChanged: {
                if (root.open)
                    Settings.audioPanelHeight = implicitHeight + root.panelMarginTop;
            }
